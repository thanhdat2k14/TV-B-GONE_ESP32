...
IRsend irsend1(IRLED);  // Set the GPIO to be used to sending the message.
IRsend irsend2(IRLED1);  // Set the GPIO to be used to sending the message.
IRsend irsend3(IRLED2);  // Set the GPIO to be used to sending the message.
...
void sendAllCodes() 
{
  ...
  for (i=0 ; i<num_codes; i++) 
  {
    ...
    irsend1.sendRaw(rawData, (numpairs*2) , freq);
    irsend2.sendRaw(rawData, (numpairs*2) , freq);
    irsend3.sendRaw(rawData, (numpairs*2) , freq);
    Serial.print("\n");
    yield();
